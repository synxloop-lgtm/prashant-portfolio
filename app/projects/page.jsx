...
// images
import Intervyou1 from "@/public/image/projects/loom3.png";
import Intervyou2 from "@/public/image/projects/loom2.png";
import Intervyou3 from "@/public/image/projects/loom1.png";
				...
				<div className="relative w-screen mx-auto container gap-4 px-10 grid grid-cols-1 md:grid-cols-2 mb-10">
					...
					<motion.div
						...
						<p className="text-gray-600 text-justify title text-lg">
							Stream Edge is a Loom-inspired video messaging platform that enables users to create, share, and manage screen recordings and webcam videos effortlessly. Built with modern technologies including Next.js, TypeScript, Tailwind CSS, and WebRTC, the platform offers seamless recording capabilities with instant sharing features. Users can quickly capture their screen, camera, or both, and share videos through generated links without requiring recipients to create accounts. The platform includes video management tools, analytics for view tracking, and collaborative features for team communication.
						</p>{" "}
						<div className="mt-3">
							<Button variation="primary">
								<Link href="https://github.com/kushwahaPrashant24/StreamEdge">Github</Link>
							</Button>
