...
import Me from "@/public/image/prashant.jpeg";
import MeAbout from "@/public/image/pra2.jpg";
						...
						<div className="section">
							<div className="mx-auto container grid grid-cols-1 md:grid-cols-3 gap-4 p-10 overflow-hidden md:px-20">
								<motion.div
									...
									Hi, I’m Prashant — a Junior Full-Stack Developer specializing in modern Web Development. I enjoy building responsive, scalable, and user-friendly applications, with hands-on experience across both front-end and back-end technologies.
									</motion.p>
									<motion.div
										...
										<Button variation="primary">
											<Link
												href={"https://drive.google.com/file/d/1VlLCQaS6305sNcc4R1Z-8wmuIGVlmsUU/view?usp=sharing"}
												target="_blank"
							...
							<div className="relative md:h-screen w-screen  gap-4 p-10 flex justify-center items-center flex-col overflow-hidden">
								...
								<div className="z-10 w-full absolute md:w-auto  md:left-[10%] top-[60%] md:top-1/3 col-span-2 flex flex-col justify-center items-start md:items-start text-start px-10 overflow-hidden">
									...
									<motion.p
										...
										<a href="mailto:prashantkush24@gmail.com?subject=Hello&body=Hello Prashant,">
									...
									<div className="flex justify-center items-center space-x-4">
										<motion.a
											href="mailto:prashantkush24@gmail.com?subject=Hello&body=Hello Prashant,"
										...
										<motion.a
											href="https://github.com/kushwahaPrashant24"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
										...
										<motion.a
											href="www.linkedin.com/in/prashantkush24"
											target="_blank"
											rel="noopener noreferrer"
											className="flex justify-center items-center bg-gray-700 w-14 h-14 rounded-full text-gray-100 hover:bg-gray-400 transition-all ease-in-out duration-300"
											initial={{ opacity: 0, y: 40 }}
