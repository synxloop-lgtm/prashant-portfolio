...
const experiences = [
	...
	
	{
		...
		type: "Contract",
		location: "Remote",
		description: "Delivered responsive front-end and scalable back-end solutions for production-ready features. Improved authentication flow, boosted performance, and strengthened stability. Collaborated closely with the team to ensure smooth deployments.",
		skills: ["JavaScript", "React", "Node.js", "Authentication", "Performance Optimization"],
	},
	{
		id: 2,
		startDate: "Aug 2024",
		...
		type: "Contract",
		location: "Remote",
		description: "Built and integrated features with focus on performance, scalability, and user experience. Optimized integration and deployment processes to improve system efficiency.",
		skills: ["JavaScript", "React", "Node.js", "Performance Optimization", "Scalability"],
	},

	{
		...
		type: "Full-time",
		location: "Remote",
		description: "Architected and implemented scalable backend services using TypeScript, Node.js, and Express. Integrated Firebase Cloud Messaging for real-time notifications. Designed MongoDB schemas for service listings and user profiles. Implemented AWS S3 for secure image storage and built admin dashboard using Next.js.",
		skills: ["TypeScript", "Node.js", "Express", "MongoDB", "AWS S3", "Firebase", "Next.js", "API Integration"],
	},
